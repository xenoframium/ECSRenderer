...
public class TextMeshGenerator {
    public static TextInfo assemble(FontInfo fontInfo, String text, int linespacing, Vec4 foregroundColour, Vec4 backgroundColour) {
        try (MemoryStack stack = stackPush()) {
            ...
            return new TextInfo(fontInfo, new Mesh(vs, GL_TRIANGLES, uv, inds), width, height, foregroundColour, backgroundColour);
        }
    }
}
